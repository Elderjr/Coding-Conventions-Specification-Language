 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.java.impl.JavaClassImpl#getNestedClasses <em>Nested Classes</em>}</li>
 *   <li>{@link ccsl.java.impl.JavaClassImpl#getImplements <em>Implements</em>}</li>
 *   <li>{@link ccsl.java.impl.JavaClassImpl#getBlocks <em>Blocks</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JavaClassImpl extends ComplexTypeImpl implements JavaClass {
	/**
	...
	public EList getNestedClasses() {
		if (nestedClasses == null) {
			nestedClasses = new EObjectContainmentEList(JavaClass.class, this, JavaPackage.JAVA_CLASS__NESTED_CLASSES);
		}
	...
	public EList getImplements() {
		if (implements_ == null) {
			implements_ = new EObjectResolvingEList(JInterface.class, this, JavaPackage.JAVA_CLASS__IMPLEMENTS);
		}
		return implements_;
	}
	...
	public EList getBlocks() {
		if (blocks == null) {
			blocks = new EObjectContainmentEList(Block.class, this, JavaPackage.JAVA_CLASS__BLOCKS);
		}
		return blocks;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case JavaPackage.JAVA_CLASS__IMPLEMENTS:
