 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.elements.statements.impl.AccessImpl#getElementAccessed <em>Element Accessed</em>}</li>
 *   <li>{@link ccsl.elements.statements.impl.AccessImpl#getFrom <em>From</em>}</li>
 * </ul>
 *
 * @generated
 */
