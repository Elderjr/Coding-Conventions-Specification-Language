 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.java.JFor#getInitializers <em>Initializers</em>}</li>
 *   <li>{@link ccsl.java.JFor#getUpdaters <em>Updaters</em>}</li>
 * </ul>
 *
 * @see ccsl.java.JavaPackage#getJFor()
 * @model
 * @generated
 */
public interface JFor extends Block, JElement, LoopControl {
	 ...
	 * @see ccsl.java.JavaPackage#getJFor_Initializers()
	 ...
	 * @see ccsl.java.JavaPackage#getJFor_Updaters()
	 * @model type="ccsl.elements.statements.Statement" containment="true"
	 * @generated
	 */
	EList getUpdaters();
