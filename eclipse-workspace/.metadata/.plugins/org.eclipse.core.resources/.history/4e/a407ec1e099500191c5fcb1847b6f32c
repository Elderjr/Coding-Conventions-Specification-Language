 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.filters.EqualsNamedElement#getElements <em>Elements</em>}</li>
 *   <li>{@link ccsl.filters.EqualsNamedElement#isIgnoreCase <em>Ignore Case</em>}</li>
 * </ul>
 *
 * @see ccsl.filters.FiltersPackage#getEqualsNamedElement()
 * @model
 * @generated
 */
public interface EqualsNamedElement extends AtomicFilter {
	 ...
	 * @see ccsl.filters.FiltersPackage#getEqualsNamedElement_Elements()
	 ...
	 * @see ccsl.filters.FiltersPackage#getEqualsNamedElement_IgnoreCase()
	...
	/**
	 * Sets the value of the '{@link ccsl.filters.EqualsNamedElement#isIgnoreCase <em>Ignore Case</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
