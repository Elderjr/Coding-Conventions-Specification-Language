 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.filters.EqualsNamedElementWithLiterals#getNames <em>Names</em>}</li>
 *   <li>{@link ccsl.filters.EqualsNamedElementWithLiterals#isIgnoreCase <em>Ignore Case</em>}</li>
 * </ul>
 *
 * @see ccsl.filters.FiltersPackage#getEqualsNamedElementWithLiterals()
 * @model
 * @generated
 */
public interface EqualsNamedElementWithLiterals extends AtomicFilter {
	 ...
	 * @see #setNames(String)
	 * @see ccsl.filters.FiltersPackage#getEqualsNamedElementWithLiterals_Names()
	...
	/**
	 * Sets the value of the '{@link ccsl.filters.EqualsNamedElementWithLiterals#getNames <em>Names</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see ccsl.filters.FiltersPackage#getEqualsNamedElementWithLiterals_IgnoreCase()
	...
	/**
	 * Sets the value of the '{@link ccsl.filters.EqualsNamedElementWithLiterals#isIgnoreCase <em>Ignore Case</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
