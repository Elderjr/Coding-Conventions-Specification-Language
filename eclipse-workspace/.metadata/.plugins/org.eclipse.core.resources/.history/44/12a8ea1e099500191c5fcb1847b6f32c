 ...
 * </p>
 * <ul>
 *   <li>{@link ccsl.elements.statements.InfixExp#getLeft <em>Left</em>}</li>
 *   <li>{@link ccsl.elements.statements.InfixExp#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @see ccsl.elements.statements.StatementsPackage#getInfixExp()
 * @model
 * @generated
 */
public interface InfixExp extends AtomicExp {
	 ...
	 * @see ccsl.elements.statements.StatementsPackage#getInfixExp_Left()
	 ...
	 * @see ccsl.elements.statements.StatementsPackage#getInfixExp_Right()
	 * @model type="ccsl.elements.statements.Statement" containment="true"
	 * @generated
	 */
	EList getRight();
