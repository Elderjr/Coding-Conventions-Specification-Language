	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_PrimitiveType_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_PrimitiveType_name_feature",
								"_UI_PrimitiveType_type"),
						DatatypePackage.Literals.PRIMITIVE_TYPE__NAME, true, false, false,
