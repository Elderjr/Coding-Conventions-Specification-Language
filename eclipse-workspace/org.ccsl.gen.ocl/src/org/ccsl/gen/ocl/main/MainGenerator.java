...
/**
 * Entry point of the 'MainGenerator' generation module.
 *
 * @generated
 */
public class MainGenerator extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/org/ccsl/gen/ocl/main/mainGenerator";
     ...
     * @generated
     */
    public MainGenerator(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public MainGenerator(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                MainGenerator generator = new MainGenerator(modelURI, folder, arguments);
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if(!isInWorkspace(ccslPackage.class)) {
