 ...
 * </p>
 * <ul>
 *   <li>{@link codingConvetionMetamodel.impl.RuleImpl#isNegated <em>Negated</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class RuleImpl extends MinimalEObjectImpl.Container implements Rule {
	...
	protected EClass eStaticClass() {
		return CodingConventionsMetamodelPackage.Literals.RULE;
	}
	...
	public void setNegated(boolean newNegated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodingConventionsMetamodelPackage.RULE__NEGATED,
					oldNegated, negated));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CodingConventionsMetamodelPackage.RULE__NEGATED:
