 ...
 * </p>
 * <ul>
 *   <li>{@link codingConvetionMetamodel.impl.CompositeRuleImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link codingConvetionMetamodel.impl.CompositeRuleImpl#getRule <em>Rule</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositeRuleImpl extends RuleImpl implements CompositeRule {
	...
	protected EClass eStaticClass() {
		return CodingConventionsMetamodelPackage.Literals.COMPOSITE_RULE;
	}
	...
	public void setOperator(LogicOperators newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CodingConventionsMetamodelPackage.COMPOSITE_RULE__OPERATOR, oldOperator, operator));
	}
	...
	public EList getRule() {
		if (rule == null) {
			rule = new EObjectContainmentEList(Rule.class, this,
					CodingConventionsMetamodelPackage.COMPOSITE_RULE__RULE);
		}
		return rule;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case CodingConventionsMetamodelPackage.COMPOSITE_RULE__RULE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CodingConventionsMetamodelPackage.COMPOSITE_RULE__OPERATOR:
			return getOperator();
		case CodingConventionsMetamodelPackage.COMPOSITE_RULE__RULE:
			return getRule();
		}
