 ...
 * </p>
 * <ul>
 *   <li>{@link codingConvetionMetamodel.filters.impl.CompositeFilterImpl#getFilter <em>Filter</em>}</li>
 *   <li>{@link codingConvetionMetamodel.filters.impl.CompositeFilterImpl#getOperator <em>Operator</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositeFilterImpl extends FilterImpl implements CompositeFilter {
	...
	public EList getFilter() {
		if (filter == null) {
			filter = new EObjectContainmentEList(Filter.class, this, FiltersPackage.COMPOSITE_FILTER__FILTER);
		}
		return filter;
	}
