 ...
 * </p>
 * <ul>
 *   <li>{@link codingConvetionMetamodel.elements.statements.impl.MethodInvocationImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodInvocationImpl extends AccessImpl implements MethodInvocation {
	...
	public EList getParams() {
		if (params == null) {
			params = new EObjectContainmentEList(Statement.class, this, StatementsPackage.METHOD_INVOCATION__PARAMS);
		}
		return params;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case StatementsPackage.METHOD_INVOCATION__PARAMS:
