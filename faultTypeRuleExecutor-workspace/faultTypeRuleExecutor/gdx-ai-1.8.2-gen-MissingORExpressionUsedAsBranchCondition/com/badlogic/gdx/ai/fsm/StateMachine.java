...
public interface StateMachine<E, S extends State<E>> extends Telegraph {
	 ...
	 * <p>
	 * Implementation classes should invoke first the 
	 * { @code  update}
	 *  method of the global state (if any) then the 
	 * { @code  update}
	...
	*/
	 ...
	 * <p>
	 * Implementation classes should invoke the 
	 * { @code  update}
	 *  method of the global state every time the FSM is updated. Also, they
	 * should never invoke its 
	 * { @code  enter}
	 *  and 
	 * { @code  exit}
	 *  method.
