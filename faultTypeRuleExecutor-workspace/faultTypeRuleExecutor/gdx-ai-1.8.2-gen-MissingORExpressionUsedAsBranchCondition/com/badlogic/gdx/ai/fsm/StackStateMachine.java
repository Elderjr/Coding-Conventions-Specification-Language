 ...
 * A 
 * { @link StateMachine}
 *  implementation that keeps track of all previous 
 * { @link State}
 * s via a stack. This makes sense for example
...
public class StackStateMachine<E, S extends State<E>> extends DefaultStateMachine<E, S> {
	...
	/**
	 * Creates a 
	 * { @code  StackStateMachine}
	 *  with no owner, initial state and global state. 
	*/
	...
	*/
	 ...
	 * Creates a 
	 * { @code  StackStateMachine}
	 *  for the specified owner and initial state.
	* @param owner  the owner of the state machine
	...
	*/
	 ...
	 * Creates a 
	 * { @code  StackStateMachine}
	 *  for the specified owner, initial state and global state.
	* @param owner  the owner of the state machine
	* @param initialState  the initial state
	...
	* @return   { @code  True}  in case there was a previous state that we were able to revert to. In case there is no previous state, no state change occurs and  { @code  false}  will be returned. 
	*/
	@Override
