 ...
 * The 
 * { @code  Timepiece}
 *  is the AI clock which gives you the current time and the last delta time i.e., the time span between the
 ...
 * libgdx or not. It is needed because some parts of gdx-ai (like for instance 
 ...
 * behavior and 
 * { @link Wait}
 *  task) have a notion of spent time and we want to support game pause. It's developer's responsibility
