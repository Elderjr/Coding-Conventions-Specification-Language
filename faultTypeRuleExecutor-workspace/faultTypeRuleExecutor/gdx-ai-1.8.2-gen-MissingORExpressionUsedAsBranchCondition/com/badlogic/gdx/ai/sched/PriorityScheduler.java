 ...
 *  works like a 
 * { @link LoadBalancingScheduler}
 *  but allows different tasks to get a different share of
...
public class PriorityScheduler extends SchedulerBase<PrioritySchedulableRecord> {
	...
	*/
	 ...
	 * { @code  PriorityScheduler}
	 * .
	* @param dryRunFrames  number of frames simulated by the dry run to calculate the phase when adding a schedulable via { @link #addWithAutomaticPhasing(Schedulable , int )}  and  { @link #addWithAutomaticPhasing(Schedulable , int , float )}  
	*/
	...
	*/
	 ...
	 * { @code  frequency}
	 * , priority 1 and a phase calculated by a dry run
	 * of the scheduler.
