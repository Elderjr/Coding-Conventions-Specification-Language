 ...
 * A 
 * { @code  Scheduler}
 *  works by assigning a pot of execution time among a variety of tasks, based on which ones need the time.
 * <p>
 ...
 * Notes:
 * <ul>
 * <li><b>Hierarchical Scheduling</b>: 
 * { @code  Scheduler}
 *  extends the 
 * { @link Schedulable}
 *  interface, allowing a scheduling system to
...
public interface Scheduler extends Schedulable {
	 ...
	 * { @code  frequency}
	 *  and a phase calculated by this scheduler.
