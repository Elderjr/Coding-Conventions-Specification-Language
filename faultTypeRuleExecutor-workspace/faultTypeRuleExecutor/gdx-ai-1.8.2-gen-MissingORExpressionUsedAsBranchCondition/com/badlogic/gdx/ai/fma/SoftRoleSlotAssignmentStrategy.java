...
/**
 * { @code  SoftRoleSlotAssignmentStrategy}
 *  is a concrete implementation of 
 * { @link BoundedSlotAssignmentStrategy}
 *  that supports soft
...
public class SoftRoleSlotAssignmentStrategy<T extends Vector<T>> extends BoundedSlotAssignmentStrategy<T> {
	 ...
	 * Creates a 
	 * { @code  SoftRoleSlotAssignmentStrategy}
	 *  with the given slot cost provider and no cost threshold.
	...
	*/
	 ...
	 * Creates a 
	 * { @code  SoftRoleSlotAssignmentStrategy}
	 *  with the given slot cost provider and cost threshold.
	* @param slotCostProvider  the slot cost provider
	...
	*/
	...
	public void updateSlotAssignments(Array<SlotAssignment<T>> assignments) {
		...
		if (numberOfAssignments > filledSlots.size)
			filledSlots.ensureCapacity(numberOfAssignments - filledSlots.size);
