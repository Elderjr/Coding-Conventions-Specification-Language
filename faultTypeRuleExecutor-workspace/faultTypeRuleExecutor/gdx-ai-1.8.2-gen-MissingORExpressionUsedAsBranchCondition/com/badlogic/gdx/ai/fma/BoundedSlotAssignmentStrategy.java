...
/**
 * { @code  BoundedSlotAssignmentStrategy}
 *  is an abstract implementation of 
 * { @link SlotAssignmentStrategy}
 *  that supports roles.
 ...
 * { @link #calculateNumberOfSlots(Array )  calculateNumberOfSlots}
 *  method that
 * is more general (and costly) than the simplified implementation in 
 * { @link FreeSlotAssignmentStrategy}
 * . It scans the assignment
