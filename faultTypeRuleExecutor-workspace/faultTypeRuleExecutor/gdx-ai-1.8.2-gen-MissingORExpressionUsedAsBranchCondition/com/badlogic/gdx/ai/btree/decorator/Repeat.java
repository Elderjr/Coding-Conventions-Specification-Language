 ...
 * A 
 * { @code  Repeat}
 *  decorator will repeat the wrapped task a certain number of times, possibly infinite. This task always succeeds
...
public class Repeat<E> extends LoopDecorator<E> {
	 ...
	 * { @link ConstantIntegerDistribution#NEGATIVE_ONE}
	 *  which indicates an infinite number of repetitions.
	* @see #start()  
	*/
	@TaskAttribute
	...
	*/
	 ...
	 * distribution. The number of times is drawn from the distribution by the 
	 * { @link #start()}
	 *  method. Any negative value means
	 * forever.
