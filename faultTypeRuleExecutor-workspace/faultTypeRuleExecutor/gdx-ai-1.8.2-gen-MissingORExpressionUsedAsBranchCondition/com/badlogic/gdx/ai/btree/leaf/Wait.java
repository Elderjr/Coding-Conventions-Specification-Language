...
/**
 * { @code  Wait}
 *  is a leaf that keeps running for the specified amount of time then succeeds.
...
public class Wait<E> extends LeafTask<E> {
	...
	*/
	 ...
	 * Creates a 
	 * { @code  Wait}
	 *  task that immediately succeeds. 
	*/
	public Wait() {
	 ...
	 * Creates a 
	 * { @code  Wait}
	 *  task running for the specified number of seconds.
	...
	*/
	 ...
	 *  to get the current AI time. This means that
	 * <ul>
	 * <li>if you forget to 
