...
/**
 * The 
 * { @code  BehaviorTreeLibraryManager}
 *  is a singleton in charge of the creation of behavior trees using the underlying library.
 * If no library is explicitly set (see the method 
 * { @link #setLibrary(BehaviorTreeLibrary )}
 * ), a default library instantiated by
 * the constructor 
 * { @link BehaviorTreeLibrary#BehaviorTreeLibrary()  BehaviorTreeLibrary()}
 *  is used instead.
* @author  davebaol 
*/
