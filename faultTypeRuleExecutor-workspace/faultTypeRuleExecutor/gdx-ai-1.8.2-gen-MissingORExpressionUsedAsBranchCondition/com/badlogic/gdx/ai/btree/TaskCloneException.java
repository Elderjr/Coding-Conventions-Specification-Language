...
/**
 * A 
 * { @code  TaskCloneException}
 *  is thrown when an exception occurs during task cloning. See 
 * { @link Task#cloneTask()}
* @author  davebaol 
*/
...
public class TaskCloneException extends RuntimeException {
	 ...
	 * Constructs a new 
	 * { @code  TaskCloneException}
	 *  with null as its detail message. The cause is not initialized, and may
	...
	*/
	 ...
	 * { @code  cause}
	 *  is not automatically incorporated in this runtime exception's
	 * detail message.
	* @param message  the detail message which is saved for later retrieval by the  { @link #getMessage()}  method.
	* @param cause  the cause (which is saved for later retrieval by the  { @link #getCause()}  method). A  { @code  null}  value is permitted, and indicates that the cause is nonexistent or unknown. 
	*/
