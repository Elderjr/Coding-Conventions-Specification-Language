...
/**
 * This is the abstract base class of all behavior tree tasks. The 
 * { @code  Task}
 *  of a behavior tree has a status, one control and a
 * list of children.
...
public abstract class Task<E> implements Poolable {
	...
	* Override
	* public 
	* { @code  <T> Task<T> cloneTask (Task<T>}
	*  task) {
	* if (kryo == null) {
	* kryo = new Kryo();
	...
	*/
	...
	/**
	 * This method contains the update logic of this task. The actual implementation MUST call 
	 * { @link #running()}
	 * ,
	 * { @link #success()}
	 *  or 
	...
	*/
	 ...
	 * This method will be called in 
	 * { @link #run()}
	 *  to inform control that this task has finished running with a failure result 
	*/
	...
	*/
	...
	/**
	 * Clones this task to a new one. If you don't specify a clone strategy through 
	 * { @link TASK_CLONER}
	 *  the new task is
	 * instantiated via reflection and 
	 * { @link #copyTo(Task )}
	 *  is invoked.
	...
	*/
	...
	/**
	 * Copies this task to the given task. This method is invoked by 
	 * { @link #cloneTask()}
	 *  only if 
	 * { @link TASK_CLONER}
	 *  is
