 ...
 * An 
 * { @code  Include}
 *  decorator grafts a subtree. When the subtree is grafted depends on the value of the 
 * { @link lazy}
 *  attribute:
 * at clone-time if is 
 * { @code  false}
...
public class Include<E> extends Decorator<E> {
	...
	*/
	 ...
	 * { @link BehaviorTreeLibraryManager}
	 * . Subsequent calls do nothing since the child has already been set. A
