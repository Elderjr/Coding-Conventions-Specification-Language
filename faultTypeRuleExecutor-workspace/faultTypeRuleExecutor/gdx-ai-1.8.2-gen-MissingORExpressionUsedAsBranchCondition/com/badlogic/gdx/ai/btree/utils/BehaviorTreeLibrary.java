...
/**
 * A 
 * { @code  BehaviorTreeLibrary}
 *  is a repository of behavior tree archetypes. Behavior tree archetypes never run. Indeed, they are
...
public class BehaviorTreeLibrary {
	 ...
	 * Creates a 
	 * { @code  BehaviorTreeLibrary}
	 *  using the new internal resolver returned by the call
	...
	*/
	 ...
	 * Creates a 
	 * { @code  BehaviorTreeLibrary}
	 *  with the given debug level and using the new internal resolver returned by the call
	 * { @link FileSystem#newResolver(FileType )  GdxAI.getFileSystem().newResolver(FileType.Internal)}
	 * .
	...
	*/
	 ...
	 * Creates a 
	 * { @code  BehaviorTreeLibrary}
	 *  with the given resolver and debug level.
	* @param resolver  the  { @link FileHandleResolver}
	* @param parseDebugLevel  the debug level the parser will use 
	*/
	...
	*/
	 ...
	 * Registers the 
	 * { @link BehaviorTree}
	 *  archetypeTree with the specified reference. Existing archetypes in the repository with
	...
	*/
	 ...
	 * Returns 
	 * { @code  true}
	 *  if an archetype tree with the specified reference is registered in this library.
	* @param treeReference  the tree identifier, typically a path.
