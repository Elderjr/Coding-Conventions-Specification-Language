...
public class BehaviorTree<E> extends Task<E> {
	 ...
	 * Creates a 
	 * { @code  BehaviorTree}
	 *  with no root task and no blackboard object. Both the root task and the blackboard object must
	 * be set before running this behavior tree, see 
	 * { @link #addChild(Task )  addChild()}
	 *  and 
	 * { @link #setObject(Object )  setObject()}
	 * respectively. 
	*/
	public BehaviorTree() {
		this(null, null);
	 ...
	 * before running this behavior tree, see 
	 * { @link #addChild(Task )  addChild()}
	 *  and 
	 * { @link #setObject(Object )  setObject()}
	 * respectively.
	...
	* { @link BehaviorTree#addListener(Listener )}
	*  method. When a task event occurs, the corresponding method is invoked.
	* @param < E >  type of the blackboard object that tasks use to read or modify game state
	* @author  davebaol 
	*/
