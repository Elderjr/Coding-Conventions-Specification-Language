...
public abstract class LeafTask<E> extends Task<E> {
	...
	*/
	...
	/**
	 * This method contains the update logic of this leaf task. The actual implementation MUST return one of 
	 * { @link Status#RUNNING}
	 * , 
	 * { @link Status#SUCCEEDED}
	 *  or 
	 * { @link Status#FAILED}
	 * . Other return values will cause an 
	...
	*/
	...
	/**
	 * This method contains the update logic of this task. The implementation delegates the 
	 * { @link #execute()}
	 *  method. 
	*/
	@Override
