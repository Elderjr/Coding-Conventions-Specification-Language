 ...
 * The 
 * { @code  Location}
 *  interface represents any game object having a position and an orientation.
...
public interface Location<T extends Vector<T>> {
	...
	*/
	 ...
	 * <p>
	 * This method is used internally to instantiate locations of the correct type parameter 
	 * { @code  T}
