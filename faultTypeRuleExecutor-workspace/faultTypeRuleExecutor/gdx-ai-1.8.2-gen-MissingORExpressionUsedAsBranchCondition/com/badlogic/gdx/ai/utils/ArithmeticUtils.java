...
public final class ArithmeticUtils {
	...
	*/
	public static int gcdPositive(int a, int b) {
		...
		b >>= bTwos;
		final int shift = aTwos <= bTwos ? aTwos : bTwos;
		// min(aTwos, bTwos);
	 ...
	 * <ul>
	 * <li>The invocations 
	 * { @code  lcm(Integer.MIN_VALUE, n)}
	 *  and 
	 * { @code  lcm(n, Integer.MIN_VALUE)}
	 * , where 
	 * { @code  abs(n)}
	 *  is a power
	 * of 2, throw an 
	 * { @code  ArithmeticException}
	 * , because the result would be 2^31, which is too large for an 
	 * { @code  int}
	 *  value.</li>
	 * <li>The result of 
	 * { @code  lcm(0, x)}
	...
	*/
	...
	/**
	 * Returns the greatest common divisor of the given absolute values. This implementation uses 
	 * { @link #gcdPositive(int , int )}
	...
	*/
	...
	/**
	 * Returns the least common multiple of the given absolute values. This implementation uses 
	 * { @link #lcmPositive(int , int )}
	 *  and
