...
public class CircularBuffer<T> {
	...
	*/
	 ...
	 * Returns 
	 * { @code  true}
	 *  if this circular buffer is empty; 
	 * { @code  false}
	 *  otherwise. 
	*/
	 ...
	 * Returns 
	 * { @code  true}
	 *  if this circular buffer contains as many items as its capacity; 
	 * { @code  false}
	 *  otherwise. 
	*/
	...
	*/
	 ...
	 * Returns 
	 * { @code  true}
	 *  if this circular buffer can be resized; 
	 * { @code  false}
	 *  otherwise. 
	*/
	...
	*/
	protected void resize(int newCapacity) {
		...
		newItems = (T[]) ArrayReflection.newInstance(items.getClass().getComponentType(), newCapacity);
		if (tail > head) {
