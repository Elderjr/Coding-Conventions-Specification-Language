...
/**
 * A Telegram is the container of a message. The 
 * { @link MessageDispatcher}
 *  manages telegram life-cycle.
* @author  davebaol 
*/
public class Telegram implements Comparable<Telegram>, Poolable {
	...
	*/
	public int message;
	/**
	 * The return receipt status of this telegram. Its value should be 
	 * { @link RETURN_RECEIPT_UNNEEDED}
	 * , 
	 * { @link RETURN_RECEIPT_NEEDED}
	 *  or
	...
	*/
	...
	public boolean equals(Object obj) {
		...
		if (Float.floatToIntBits(timestamp) != Float.floatToIntBits(other.timestamp))
			return false;
