 ...
 *  is in charge of the creation, dispatch, and management of telegrams.
* @author  davebaol 
*/
public class MessageDispatcher implements Telegraph {
	...
	public void addListener(Telegraph listener, int msg) {
		...
		if (providers != null) {
			for (int i = 0, n = providers.size; i < n; i++) {
				...
				if (info != null) {
					Telegraph sender = ClassReflection.isInstance(Telegraph.class, provider) ? (Telegraph) provider
							: null;
	...
	*/
	 ...
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean )  dispatchMessage(0, null, null, msg, null, false)}
	* @param msg  the message code 
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean )  dispatchMessage(0, sender, null, msg, null, false)}
	...
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean )  dispatchMessage(0, sender, null, msg, null, needsReturnReceipt)}
	* @param sender  the sender of the telegram
	* @param msg  the message code
	...
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean )  dispatchMessage(0, null, null, msg, extraInfo, false)}
	* @param msg  the message code
	...
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean )  dispatchMessage(0, sender, null, msg, extraInfo, false)}
	* @param sender  the sender of the telegram
	* @param msg  the message code
	* @param extraInfo  an optional object 
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean )  dispatchMessage(0, sender, null, msg, extraInfo, needsReturnReceipt)}
	* @param sender  the sender of the telegram
	* @param msg  the message code
	* @param extraInfo  an optional object
	* @param needsReturnReceipt  whether the return receipt is needed or not
	...
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean )  dispatchMessage(0, sender, receiver, msg, null, false)}
	* @param sender  the sender of the telegram
	* @param receiver  the receiver of the telegram; if it's  { @code  null}  the telegram is broadcasted to all the receivers registered for the specified message code
	* @param msg  the message code 
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean )  dispatchMessage(0, sender, receiver, msg, null, needsReturnReceipt)}
	* @param sender  the sender of the telegram
	* @param receiver  the receiver of the telegram; if it's  { @code  null}  the telegram is broadcasted to all the receivers registered for the specified message code
	* @param msg  the message code
	* @param needsReturnReceipt  whether the return receipt is needed or not
	...
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean )  dispatchMessage(0, sender, receiver, msg, extraInfo, false)}
	* @param sender  the sender of the telegram
	* @param receiver  the receiver of the telegram; if it's  { @code  null}  the telegram is broadcasted to all the receivers registered for the specified message code
	* @param msg  the message code
	* @param extraInfo  an optional object 
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean )  dispatchMessage(0, sender, receiver, msg, extraInfo, needsReturnReceipt)}
	* @param sender  the sender of the telegram
	* @param receiver  the receiver of the telegram; if it's  { @code  null}  the telegram is broadcasted to all the receivers registered for the specified message code
	* @param msg  the message code
	* @param extraInfo  an optional object
	...
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean ) dispatchMessage(delay, null, null, msg, null, null)}
	...
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean ) dispatchMessage(delay, sender, null, msg, null, false)}
	* @param delay  the delay in seconds
	* @param sender  the sender of the telegram
	* @param msg  the message code 
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean ) dispatchMessage(delay, sender, null, msg, null, needsReturnReceipt)}
	* @param delay  the delay in seconds
	* @param sender  the sender of the telegram
	* @param msg  the message code
	* @param needsReturnReceipt  whether the return receipt is needed or not
	...
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean ) dispatchMessage(delay, null, null, msg, extraInfo, false)}
	* @param delay  the delay in seconds
	* @param msg  the message code
	* @param extraInfo  an optional object 
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean ) dispatchMessage(delay, sender, null, msg, extraInfo, false)}
	* @param delay  the delay in seconds
	* @param sender  the sender of the telegram
	* @param msg  the message code
	* @param extraInfo  an optional object 
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean ) dispatchMessage(delay, sender, null, msg, extraInfo, needsReturnReceipt)}
	* @param delay  the delay in seconds
	* @param sender  the sender of the telegram
	* @param msg  the message code
	* @param extraInfo  an optional object
	...
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean ) dispatchMessage(delay, sender, receiver, msg, null, false)}
	* @param delay  the delay in seconds
	* @param sender  the sender of the telegram
	* @param receiver  the receiver of the telegram; if it's  { @code  null}  the telegram is broadcasted to all the receivers registered for the specified message code
	* @param msg  the message code 
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean ) dispatchMessage(delay, sender, receiver, msg, null, needsReturnReceipt)}
	* @param delay  the delay in seconds
	* @param sender  the sender of the telegram
	* @param receiver  the receiver of the telegram; if it's  { @code  null}  the telegram is broadcasted to all the receivers registered for the specified message code
	* @param msg  the message code
	...
	*/
	 ...
	 * <p>
	 * This is a shortcut method for 
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object , boolean ) dispatchMessage(delay, sender, receiver, msg, extraInfo, false)}
	* @param delay  the delay in seconds
	* @param sender  the sender of the telegram
	* @param receiver  the receiver of the telegram; if it's  { @code  null}  the telegram is broadcasted to all the receivers registered for the specified message code
	* @param msg  the message code
	...
	*/
	public void dispatchMessage(float delay, Telegraph sender, Telegraph receiver, int msg, Object extraInfo,
		...
		if (delay <= 0.0f) {
			...
			if (debugEnabled) {
				...
				GdxAI.getLogger().info(LOG_TAG, "Instant telegram dispatched at time: " + currentTime + " by " + sender
			...
			if (debugEnabled) {
				if (added)
					GdxAI.getLogger().info(LOG_TAG, "Delayed telegram from " + sender + " for " + receiver
							+ " recorded at time " + currentTime + ". Message code is " + msg);
				else
					GdxAI.getLogger().info(LOG_TAG, "Delayed telegram from " + sender + " for " + receiver
	 ...
	 * delayed messages. Notice that the message dispatcher internally calls 
	 * { @link Timepiece#getTime() GdxAI.getTimepiece().getTime()}
	 *  to get the current AI time and properly dispatch delayed messages. This means that
	 * <ul>
	 * <li>if you forget to 
	 * { @link Timepiece#update(float )  update the timepiece}
	 *  the delayed messages won't be dispatched.</li>
	...
	*/
	public void update() {
		...
		while ((telegram = queue.peek()) != null) {
			...
			if (debugEnabled) {
				GdxAI.getLogger().info(LOG_TAG, "Queued telegram ready for dispatch: Sent to " + telegram.receiver
	...
	*/
	 ...
	 * { @link #dispatchMessage(float , Telegraph , Telegraph , int , Object )  dispatchMessage}
	 *  for immediate
	 * telegrams and 
	 * { @link #update(float )  update}
	...
	*/
	...
	/**
	 * Handles the telegram just received. This method always returns 
	 * { @code  false}
	 *  since usually the message dispatcher never
	 * receives telegrams. Actually, the message dispatcher implements 
	 * { @link Telegraph}
	...
	*/
	...
	/**
	 * A 
	 * { @code  PendingMessageCallback}
	 *  is used by the 
	 * { @link MessageDispatcher#scanQueue(PendingMessageCallback )  scanQueue}
	 *  method
	 * of the 
	 * { @link MessageDispatcher}
	 *  to report its pending messages individually.
	* @author  davebaol 
	*/
