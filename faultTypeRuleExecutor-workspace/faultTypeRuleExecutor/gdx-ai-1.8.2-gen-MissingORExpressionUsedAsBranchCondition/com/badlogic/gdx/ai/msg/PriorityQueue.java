 ...
 *  elements.
 * <p>
 * The queue can be set to accept or reject the insertion of non unique elements through the method 
 * { @code  setUniqueness}
 * .
 ...
 * arbitrarily. The queue retrieval operations 
 * { @code  poll}
 * , 
 * { @code  remove}
 * , 
 ...
 * automatically.
 * <p>
 * Iterating the queue with the method 
 * { @link #get(int )  get}
 *  is <em>not</em> guaranteed to traverse the elements of the priority
...
public class PriorityQueue<E extends Comparable<E>> {
	...
	*/
	...
	/**
	 * Inserts the specified element into this priority queue. If 
	 * { @code  uniqueness}
	 *  is enabled and this priority queue already
	...
	*/
	...
	/**
	 * Retrieves, but does not remove, the head of this queue. If this queue is empty 
	 * { @code  null}
	 *  is returned.
	...
	*/
	...
	/**
	 * Retrieves the element at the specified index. If such an element doesn't exist 
	 * { @code  null}
	 *  is returned.
	 * <p>
	...
	*/
	private void growToSize(int minCapacity) {
		...
		int newCapacity = (int) ((oldCapacity < 64) ? ((oldCapacity + 1) * CAPACITY_RATIO_HI)
				: (oldCapacity * CAPACITY_RATIO_LOW));
		if (newCapacity < 0)
			// overflow
		...
		newQueue = new Object[newCapacity];
