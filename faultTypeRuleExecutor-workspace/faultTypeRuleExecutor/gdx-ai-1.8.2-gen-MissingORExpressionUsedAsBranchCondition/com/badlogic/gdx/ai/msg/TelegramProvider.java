 ...
 * { @link MessageDispatcher#addListener}
 *  by providing optional 
 * { @link Telegram#extraInfo}
 *  to be sent
 * in a Telegram of a given type to the newly registered 
 * { @link Telegraph}
 * .
* @author  avianey 
*/
public interface TelegramProvider {
	 ...
	 * Provides 
	 * { @link Telegram#extraInfo}
	 *  to dispatch immediately when a 
	 * { @link Telegraph}
	 *  is registered for the given message
	 * type.
