...
public class PathFinderRequest<N> {
	...
	*/
	 ...
	 * Creates a 
	 * { @code  PathFinderRequest}
	 *  with the given arguments that uses the singleton message dispatcher provided by
	 * { @link MessageManager}
	 * . 
	*/
	...
	*/
	 ...
	 * { @link PathFinderRequestControl}
	 *  as soon as this request starts to be served.
	...
	*/
	 ...
	 * { @link PathFinderQueue}
	 *  when the path finder has completed the search. You have to check the
	 * { @link pathFound}
	 *  field of this request to know if a path has been found.
	* @param timeToRun  the time in nanoseconds that this call can use on the current frame
