 ...
 * target within the last 
 * { @code  N}
 *  seconds. This gives it a sort of memory and produces reasonable-looking behavior.</li>
...
public class Hide<T extends Vector<T>> extends Arrive<T> implements ProximityCallback<T> {
	...
	*/
	 ...
	 * Creates a 
	 * { @code  Hide}
	 *  behavior for the specified owner, target and proximity.
	* @param owner  the owner of this behavior
	* @param target  the target of this behavior
	...
	*/
	 ...
	 * { @code  distanceFromBoundary}
	 *  away from the object's bounding radius and directly opposite the target. It does this by scaling
