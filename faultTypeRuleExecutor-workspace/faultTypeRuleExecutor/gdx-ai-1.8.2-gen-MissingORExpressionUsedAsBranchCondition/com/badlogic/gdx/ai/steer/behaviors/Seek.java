...
/**
 * { @code  Seek}
 *  behavior moves the owner towards the target position. Given a target, this behavior calculates the linear steering
...
public class Seek<T extends Vector<T>> extends SteeringBehavior<T> {
	...
	*/
	...
	protected SteeringAcceleration<T> calculateRealSteering(SteeringAcceleration<T> steering) {
		...
		steering.linear.set(target.getPosition()).sub(owner.getPosition()).nor()
