...
/**
 * A 
 * { @code  RadiusProximity}
 *  elaborates any agents contained in the specified list that are within the radius of the owner.
 * <p>
...
public class RadiusProximity<T extends Vector<T>> extends ProximityBase<T> {
	...
	*/
	 ...
	 * Creates a 
	 * { @code  RadiusProximity}
	 *  for the specified owner, agents and radius.
