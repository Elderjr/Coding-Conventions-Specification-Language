 ...
 * A 
 * { @code  FullLimiter}
 *  provides the maximum magnitudes of speed and acceleration for both linear and angular components.
* @author  davebaol 
*/
public class FullLimiter implements Limiter {
	...
	*/
	public FullLimiter(float maxLinearAcceleration, float maxLinearSpeed, float maxAngularAcceleration,
