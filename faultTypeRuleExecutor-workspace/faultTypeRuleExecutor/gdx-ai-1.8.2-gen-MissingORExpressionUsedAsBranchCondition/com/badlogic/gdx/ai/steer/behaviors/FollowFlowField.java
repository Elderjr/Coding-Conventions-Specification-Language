...
/**
 * The 
 * { @code  FollowFlowField}
 *  behavior produces a linear acceleration that tries to align the motion of the owner with the local
 ...
 * Like 
 * { @link FollowPath}
 * , this behavior can work in a predictive manner when its 
 * { @code  predictionTime}
 *  is greater than 0.
...
public class FollowFlowField<T extends Vector<T>> extends SteeringBehavior<T> {
	...
	*/
	 ...
	 * Creates a non-predictive 
	 * { @code  FollowFlowField}
	 *  for the specified owner and flow field. Prediction time defaults to 0.
	* @param owner  the owner of this behavior
	...
	*/
	 ...
	 * Creates a 
	 * { @code  FollowFlowField}
	 *  with the specified owner, flow field and prediction time.
	* @param owner  the owner of this behavior
	* @param flowField  the flow field to follow
	* @param predictionTime  the time in the future to predict the owner's position. Can be 0 for non-predictive flow field following. 
	*/
