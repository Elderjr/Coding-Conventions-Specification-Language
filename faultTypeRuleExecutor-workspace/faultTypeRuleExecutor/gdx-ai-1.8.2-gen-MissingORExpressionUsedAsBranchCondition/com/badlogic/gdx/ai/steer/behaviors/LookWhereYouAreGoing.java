 ...
 * orientation of the character to its linear velocity on each frame update or you can use the 
 * { @code  LookWhereYouAreGoing}
 * behavior.
 * <p>
 * { @code  LookWhereYouAreGoing}
 *  behavior gives the owner angular acceleration to make it face in the direction it is moving. In
 ...
 * { @code  Face}
 *  behavior. The target orientation is calculated using the current velocity of the
...
public class LookWhereYouAreGoing<T extends Vector<T>> extends ReachOrientation<T> {
	...
	*/
	 ...
	 * for 
	 * { @code  LookWhereYouAreGoing}
	 *  because the target orientation is determined by the velocity of the owner itself.
	* @return  this behavior for chaining. 
	*/
	@Override
