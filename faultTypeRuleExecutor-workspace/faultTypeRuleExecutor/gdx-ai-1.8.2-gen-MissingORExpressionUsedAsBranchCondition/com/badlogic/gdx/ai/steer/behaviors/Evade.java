...
/**
 * { @code  Evade}
 *  behavior is almost the same as 
 * { @link Pursue}
 *  except that the agent flees from the estimated future position of
...
public class Evade<T extends Vector<T>> extends Pursue<T> {
	...
	*/
	 ...
	 * Creates a 
	 * { @code  Evade}
	 *  behavior for the specified owner and pursuer.
	* @param owner  the owner of this behavior
	* @param target  the target of this behavior, typically a pursuer
	* @param maxPredictionTime  the max time used to predict the pursuer's position assuming it continues to move with its current velocity. 
	*/
