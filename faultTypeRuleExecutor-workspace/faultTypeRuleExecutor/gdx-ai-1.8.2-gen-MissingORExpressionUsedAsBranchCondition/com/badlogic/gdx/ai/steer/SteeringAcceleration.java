...
/**
 * { @code  SteeringAcceleration}
 *  is a movement requested by the steering system. It is made up of two components, linear and angular
 * acceleration.
...
public class SteeringAcceleration<T extends Vector<T>> {
	...
	*/
	 ...
	 * Creates a 
	 * { @code  SteeringAcceleration}
	 *  with the given linear acceleration and zero angular acceleration.
	...
	*/
	 ...
	 * Creates a 
	 * { @code  SteeringAcceleration}
	 *  with the given linear and angular components.
	* @param linear  The initial linear acceleration to give this SteeringAcceleration.
	...
	*/
	 ...
	 * Returns 
	 * { @code  true}
	 *  if both linear and angular components of this steering acceleration are zero; 
	 * { @code  false}
	 *  otherwise. 
	*/
