...
/**
 * A 
 * { @code  CentralRayWithWhiskersConfiguration}
 *  uses a long central ray and two shorter whiskers.
 * <p>
...
public class CentralRayWithWhiskersConfiguration<T extends Vector<T>> extends RayConfigurationBase<T> {
	 ...
	 * Creates a 
	 * { @code  CentralRayWithWhiskersConfiguration}
	 *  for the given owner where the central ray has the specified length and
	...
	*/
	public CentralRayWithWhiskersConfiguration(Steerable<T> owner, float rayLength, float whiskerLength,
			float whiskerAngle) {
		super(owner, 3);
