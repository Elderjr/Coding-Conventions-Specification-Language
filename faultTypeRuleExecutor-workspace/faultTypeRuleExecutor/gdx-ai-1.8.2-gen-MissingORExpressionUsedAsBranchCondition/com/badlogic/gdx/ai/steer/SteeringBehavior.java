...
/**
 * A 
 * { @code  SteeringBehavior}
 *  calculates the linear and/or angular accelerations to be applied to its owner.
...
public abstract class SteeringBehavior<T extends Vector<T>> {
	...
	*/
	 ...
	 * Creates a 
	 * { @code  SteeringBehavior}
	 *  for the specified owner. The behavior is enabled and has no explicit limiter, meaning
	...
	*/
	 ...
	 * Creates a 
	 * { @code  SteeringBehavior}
	 *  for the specified owner and limiter. The behavior is enabled.
	* @param owner  the owner of this steering behavior
	...
	*/
	 ...
	 * Creates a 
	 * { @code  SteeringBehavior}
	 *  for the specified owner and activation flag. The behavior has no explicit limiter,
	...
	*/
	 ...
	 * Creates a 
	 * { @code  SteeringBehavior}
	 *  for the specified owner, limiter and activation flag.
	* @param owner  the owner of this steering behavior
	* @param limiter  the limiter of this steering behavior
	* @param enabled  a flag indicating whether this steering behavior is enabled or not 
	*/
	...
	*/
	 ...
	 * { @link #calculateSteering(SteeringAcceleration )}
	...
	*/
	 ...
	 * <p>
	 * This method is used internally to instantiate vectors of the correct type parameter 
	 * { @code  T}
	 * . This technique keeps the API
