...
/**
 * { @code  ProximityBase}
 *  is the base class for any concrete proximity based on an iterable collection of agents.
...
public abstract class ProximityBase<T extends Vector<T>> implements Proximity<T> {
	...
	*/
	 ...
	 * <p>
	 * Note that, being this field of type 
	 * { @code  Iterable}
	 * , you can either use java or libgdx collections. See
	...
	*/
	 ...
	 * Creates a 
	 * { @code  ProximityBase}
	 *  for the specified owner and list of agents.
