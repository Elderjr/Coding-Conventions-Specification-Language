...
/**
 * { @code  GroupBehavior}
 *  is the base class for the steering behaviors that take into consideration the agents in the game world
 * that are within the immediate area of the owner. This immediate area is defined by a 
 * { @link Proximity}
 *  that is in charge of
 * finding and processing the owner's neighbors through the given 
 * { @link ProximityCallback}
 * .
