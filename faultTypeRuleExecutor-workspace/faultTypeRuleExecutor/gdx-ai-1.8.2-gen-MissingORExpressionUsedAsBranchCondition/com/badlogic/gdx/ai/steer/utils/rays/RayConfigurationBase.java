...
/**
 * { @code  RayConfigurationBase}
 *  is the base class for concrete ray configurations having a fixed number of rays.
...
public abstract class RayConfigurationBase<T extends Vector<T>> implements RayConfiguration<T> {
	 ...
	 * Creates a 
	 * { @code  RayConfigurationBase}
	 *  for the given owner and the specified number of rays.
