...
/**
 * { @code  Alignment}
 *  is a group behavior producing a linear acceleration that attempts to keep the owner aligned with the agents in
 * its immediate area defined by the given 
 * { @link Proximity}
 * . The acceleration is calculated by first iterating through all the
 ...
 * <p>
 * Cars moving along roads demonstrate 
 * { @code  Alignment}
 *  type behavior. They also demonstrate 
 * { @link Separation}
 *  as they try to
...
public class Alignment<T extends Vector<T>> extends GroupBehavior<T> implements ProximityCallback<T> {
	 ...
	 * Creates an 
	 * { @code  Alignment}
	 *  behavior for the specified owner and proximity.
