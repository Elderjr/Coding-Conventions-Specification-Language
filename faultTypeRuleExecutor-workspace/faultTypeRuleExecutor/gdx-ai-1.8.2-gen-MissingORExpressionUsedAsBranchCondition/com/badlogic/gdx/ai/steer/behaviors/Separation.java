...
/**
 * { @code  Separation}
 *  is a group behavior producing a steering acceleration repelling from the other neighbors which are the agents
 * in the immediate area defined by the given 
 * { @link Proximity}
 * . The acceleration is calculated by iterating through all the
