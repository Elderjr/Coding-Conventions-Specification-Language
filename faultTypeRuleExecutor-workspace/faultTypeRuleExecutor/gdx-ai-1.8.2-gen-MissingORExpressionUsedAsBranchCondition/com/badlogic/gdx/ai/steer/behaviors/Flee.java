...
/**
 * { @code  Flee}
 *  behavior does the opposite of 
 * { @link Seek}
 * . It produces a linear steering force that moves the agent away from a
 * target position.
...
public class Flee<T extends Vector<T>> extends Seek<T> {
	...
	*/
	...
	protected SteeringAcceleration<T> calculateRealSteering(SteeringAcceleration<T> steering) {
		...
		steering.linear.set(owner.getPosition()).sub(target.getPosition()).nor()
