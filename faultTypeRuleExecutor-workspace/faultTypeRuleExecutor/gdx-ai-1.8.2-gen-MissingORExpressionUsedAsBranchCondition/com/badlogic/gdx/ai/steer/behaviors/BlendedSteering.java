 ...
 * { @code  BlendedSteering}
 *  as a weighted mean, because it's not.
 * <p>
 * With 
 * { @code  BlendedSteering}
 *  you can combine multiple behaviors to get a more complex behavior. It can work fine, but the
...
public class BlendedSteering<T extends Vector<T>> extends SteeringBehavior<T> {
	...
	*/
	 ...
	 * accelerations. You can use 
	 * { @link NullLimiter#NEUTRAL_LIMITER}
	 *  to avoid all truncations.
	* @return  this behavior for chaining. 
	*/
	@Override
