...
public class MatchVelocity<T extends Vector<T>> extends SteeringBehavior<T> {
	...
	*/
	 ...
	 * Creates a 
	 * { @code  MatchVelocity}
	 *  behavior for the given owner. No target is set. The maxLinearAcceleration is set to 100. The
	...
	*/
	 ...
	 * Creates a 
	 * { @code  MatchVelocity}
	 *  behavior for the given owner and target. The timeToTarget is set to 0.1 seconds.
	* @param owner  the owner of this behavior
	...
	*/
	 ...
	 * Creates a 
	 * { @code  MatchVelocity}
	 *  behavior for the given owner, target and timeToTarget.
	* @param owner  the owner of this behavior
	* @param target  the target of this behavior
