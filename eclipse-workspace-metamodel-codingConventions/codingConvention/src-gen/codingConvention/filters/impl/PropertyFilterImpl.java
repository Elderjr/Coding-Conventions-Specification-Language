 ...
 * </p>
 * <ul>
 *   <li>{@link codingConvention.filters.impl.PropertyFilterImpl#getProperty <em>Property</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public NotificationChain basicSetProperty(Property newProperty, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					FiltersPackage.PROPERTY_FILTER__PROPERTY, oldProperty, newProperty);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newProperty != property) {
			...
			if (property != null)
				msgs = ((InternalEObject) property).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - FiltersPackage.PROPERTY_FILTER__PROPERTY, null, msgs);
			if (newProperty != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, FiltersPackage.PROPERTY_FILTER__PROPERTY, newProperty,
					newProperty));
	}
