/**
 */
package codingConvention.filters.util;
...
public class FiltersAdapterFactory extends AdapterFactoryImpl {
	...
	protected FiltersSwitch<Adapter> modelSwitch = new FiltersSwitch<Adapter>() {
		...
		@Override
		public Adapter caseCompositeFilter(CompositeFilter object) {
			return createCompositeFilterAdapter();
		}

		@Override
		public Adapter caseAtomicFilter(AtomicFilter object) {
		...
		@Override
		public Adapter caseTemplateFilter(TemplateFilter object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link codingConvention.filters.Filter <em>Filter</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link codingConvention.filters.CompositeFilter <em>Composite Filter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link codingConvention.filters.AtomicFilter <em>Atomic Filter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link codingConvention.filters.PropertyFilter <em>Property Filter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link codingConvention.filters.TemplateFilter <em>Template Filter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
