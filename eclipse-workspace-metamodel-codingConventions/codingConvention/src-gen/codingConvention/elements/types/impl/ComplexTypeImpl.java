 ...
 * </p>
 * <ul>
 *   <li>{@link codingConvention.elements.types.impl.ComplexTypeImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public EList<Property> getProperties() {
		if (properties == null) {
			properties = new EObjectContainmentEList<Property>(Property.class, this,
					TypesPackage.COMPLEX_TYPE__PROPERTIES);
		}
		return properties;
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Element.class) {
			...
			case ElementsPackage.ELEMENT__PROPERTIES:
				return TypesPackage.COMPLEX_TYPE__PROPERTIES;
			default:
				return -1;
			}
		}
