 ...
 * </p>
 * <ul>
 *   <li>{@link codingConvention.elements.statements.impl.BodyImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BodyImpl extends StatementImpl implements Body {
	/**
	...
	protected EClass eStaticClass() {
		return StatementsPackage.Literals.BODY;
	}
	...
	public EList<Statement> getStatements() {
		if (statements == null) {
			statements = new EObjectContainmentEList<Statement>(Statement.class, this,
					StatementsPackage.BODY__STATEMENTS);
		}
		return statements;
	}
